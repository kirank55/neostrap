          ...
          <SidebarGroupContent className="pl-4">
            <SidebarMenu className="gap-2">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={location.pathname === "/docs/essential"}
                  variant={location.pathname === "/docs/essential" ? "outline" : "default"}
                  className={cn(
                    "justify-start font-semibold transition-all",
                    location.pathname === "/docs/essential"
                      ? "bg-(--color-baby-blue)"
                      : "hover:translate-x-1 hover:bg-transparent"
                  )}
                >
