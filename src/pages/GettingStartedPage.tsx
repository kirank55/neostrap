...
const fontInstallCode = `<!-- Add to your HTML <head> -->
...
const fontCssCode = `/* Add to your globals.css */
body {
            ...
            <DocSection id="typography">
                ...
                <div className="space-y-8">
                    ...
                    <div className="p-6 rounded-2xl border-3 border-black bg-white shadow-[6px_6px_0_#000] space-y-4">
                        ...
                        <CodeBlock code={fontInstallCode} highlightCode={true} />
                    </div>
                    ...
                    <div className="p-6 rounded-2xl border-3 border-black bg-white shadow-[6px_6px_0_#000] space-y-4">
                        ...
                        <CodeBlock code={fontCssCode} highlightCode={true} />
                    </div>
