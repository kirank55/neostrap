...
export const SELECT_PROPS: PropDefinition[] = [
  {
    name: "children",
...
export const SELECT_USAGE_CODE = `import {
  Select,
  SelectContent,
  SelectGroup,
  SelectItem,
...
export const INSTALL_CLI_CODE = `npx shadcn@latest add https://neostrapui.pages.dev/r/neoselect.json`

export const INSTALL_DEPENDENCIES_CODE = `npm install @radix-ui/react-select lucide-react class-variance-authority clsx tailwind-merge`

export const SELECT_COMPONENT_CODE = `import * as React from "react"
