...
export const INSTALL_DEPENDENCIES_CODE = `npm install embla-carousel-react lucide-react clsx tailwind-merge`
...
export const CAROUSEL_USAGE_CODE = `import {
  Carousel,
  CarouselContent,
  CarouselItem,
  CarouselPrevious,
...
export function CarouselDemo() {
  return (
    <Carousel autoplay interval={3000} indicatorType="vertical">
      <div className="flex gap-6">
        <CarouselIndicators variant="content" indicatorType="vertical" slides={DEMO_SLIDES} className="w-48 shrink-0" />
        <div className="flex-1 relative flex items-center">
          <CarouselContent className="w-full">
            <CarouselItem>
              <div className="h-75 bg-linear-to-br from-pink-300 to-purple-400 flex items-center justify-center text-black font-bold">
                Slide 1
              </div>
            </CarouselItem>
            <CarouselItem>
              <div className="h-75 bg-linear-to-br from-green-200 to-lime-300 flex items-center justify-center text-black font-bold">
                Slide 2
              </div>
            </CarouselItem>
            <CarouselItem>
              <div className="h-75 bg-linear-to-br from-sky-200 to-indigo-300 flex items-center justify-center text-black font-bold">
                Slide 3
              </div>
            </CarouselItem>
          </CarouselContent>
...
export const CAROUSEL_COMPONENT_CODE = `import * as React from "react";
...
export const CAROUSEL_PROPS = [
  { 
    ...
    default: 'undefined', 
    description: 'Embla carousel options for advanced customization.' 
  },
  { 
    name: 'plugins', 
    type: 'CarouselPlugin', 
  ...
  },
  {
    ...
    type: 'boolean',
    default: 'undefined',
    description: 'If true, carousel loops to the first slide after the last. If omitted the component falls back to `opts.loop`; autoplay enforces looping.'
  },
  { 
    name: 'autoplay', 
    type: 'boolean', 
    default: 'false', 
    description: 'Enable automatic slide advancing.' 
  },
  { 
    name: 'interval', 
    type: 'number', 
  ...
  { 
    ...
    type: '"horizontal" | "vertical"', 
    default: '"horizontal"', 
    description: 'The orientation of progress indicators for content variant.' 
  },
]

export const VARIANT_OPTIONS = [
  { variant: 'bullets', label: 'Bullets' },
